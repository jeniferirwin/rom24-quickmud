...
void do_alist(CHAR_DATA *ch, char *argument)
{
    ...
    sprintf(buf, "There were %d rooms in all the areas listed.\n\r", total_count);
    send_to_char(buf, ch);
    // output a count of all the rooms on the MUD to the player
    sprintf(buf, "There are %d rooms in the MUD.\n\r", top_room);
    send_to_char(buf, ch);
